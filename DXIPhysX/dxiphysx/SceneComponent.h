...
namespace dxiphysx
{
	...
	public:
		...
		void OnUpdate( me::scene::Scene * scene, me::IRenderer * renderer, const me::RenderInfo & renderInfo ) override;
		void OnRender( me::scene::Scene * scene, me::IRenderer * renderer, const me::RenderInfo & renderInfo ) override;
