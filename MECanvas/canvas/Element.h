...
namespace canvas
{
	...
	{
	public:
		Element( me::game::IGame * gameInstance, unify::V2< float > offset = { 0, 0 }, unify::Size< float > size = { 0, 0 }, Anchor anchor = Anchor::Center );
