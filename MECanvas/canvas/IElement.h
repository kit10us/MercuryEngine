...
namespace canvas
{
	...
	public:
		...
		/// </summary>
		virtual void UpdateLayout( me::UpdateParams params, unify::Rect< float > parentArea ) = 0;

		/// <summary>
		/// Updates the element. What this actually does is element type specific.
		/// </summary>
		virtual void Update( const me::UpdateParams & params ) = 0;

		/// <summary>
		/// Renders the element.
		/// </summary>
		virtual void Render( const me::render::Params & params ) = 0;
