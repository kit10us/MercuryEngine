...
namespace dxi
{
    namespace scene
    {
	    ...
	    public:
		    ...
		    Object();
			explicit Object( dxi::geo::Geometry::shared_ptr geometry, std::shared_ptr< physics::IInstance > physics = std::shared_ptr< physics::IInstance >() );
			Object( dxi::geo::Geometry::shared_ptr geometry, const unify::V3< float > position );
		    virtual ~Object();
			...
			geo::Geometry::shared_ptr GetGeometry();
			void SetGeometry( geo::Geometry::shared_ptr geometry );
