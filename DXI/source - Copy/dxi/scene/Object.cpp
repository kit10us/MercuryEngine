...
Object::Object( geo::Geometry::shared_ptr geometry, std::shared_ptr< physics::IInstance > physics )
: m_enabled( true )
, m_visible( true )
, m_geometry( geometry )
...
Object::Object( geo::Geometry::shared_ptr geometry, const unify::V3< float > position )
: m_enabled( true )
, m_visible( true )
, m_geometry( geometry )
, m_geometryInstanceData( geometry->CreateInstanceData() )
...
geo::Geometry::shared_ptr Object::GetGeometry()
{
	return m_geometry;
}

void Object::SetGeometry( geo::Geometry::shared_ptr geometry )
{
	m_geometry = geometry;
...
void Object::Render( RenderInfo renderInfo )
{
	...
	{
		m_frame.Update();
		unify::Matrix final = m_geometryMatrix * m_frame.GetFinalMatrix() * renderInfo.GetFinalMatrix();		
