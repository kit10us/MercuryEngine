...
#include <dxi/dae/DAE_Document.h>
#include <dxi/core/Game.h>

using namespace dxi;
using namespace dae;

Document::Document( const qlib::file::Path & filePath, dae::util::IEffectSolver * effectSolver, Managers managers )
...
Managers Document::GetManagers()
{
	return m_managers;
}

TextureManager::shared_ptr Document::GetTextureManager()
{
	return m_managers.GetTextureManager();
}

PixelShaderManager::shared_ptr Document::GetPixelShaderManager()
{
	return m_managers.GetPixelShaderManager();
}

VertexShaderManager::shared_ptr Document::GetVertexShaderManager()
{
	return m_managers.GetVertexShaderManager();
}

EffectManager::shared_ptr Document::GetEffectManager()
{
	return m_managers.GetEffectManager();
}
