...
#include <dxi/VertexShaderManager.h>
...
namespace dxi
{
	namespace dae
	{
		...
		public:
			...
			virtual TextureManager::shared_ptr GetTextureManager() = 0;
			virtual PixelShaderManager::shared_ptr GetPixelShaderManager() = 0;
			virtual VertexShaderManager::shared_ptr GetVertexShaderManager() = 0;
			virtual EffectManager::shared_ptr GetEffectManager() = 0;
		};
	}
}