...
void WindowsOS::CreateDirectX( IDirect3DDevice9 *& dxDevice )
{
...
void WindowsOS::DestroyDirectX( IDirect3DDevice9 *& dxDevice )
{
	if ( dxDevice )
	{
		dxDevice->Release();
