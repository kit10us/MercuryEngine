...
namespace dxi
{
	...
	// These flags determine if we are supposed to implement any effects...
	enum EffectFlag
	{
		EFFECT_NONE = FLAGNULL,
		EFFECT_CULLING = FLAG02,			// Force culling
	};
	...
	public:
		...
		void FlagUsage( EffectFlag dwFlag, bool bUse );
		bool HasBlend() const;
