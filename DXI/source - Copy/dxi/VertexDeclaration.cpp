...
bool VertexDeclaration::GetElement( const std::string name, D3DVERTEXELEMENT9 & element ) const
{
	ElementMap::const_iterator itr = m_elementMap.find( name );
	return GetElement( itr->second, element );
}

bool VertexDeclaration::GetElement( size_t index, D3DVERTEXELEMENT9 & element ) const
{
...
bool VertexDeclaration::FindElement( D3DVERTEXELEMENT9 toFind, D3DVERTEXELEMENT9 & element ) const
{
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, const unify::V2< float > & v )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( ! FindElement( element, elementFound ) )
	{
		return false;
	}
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, const unify::V3< float > & v )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, const unify::V4< float > & v )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, const unify::TexCoords & tc )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, const unify::Color & c )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, const unify::ColorUnit & cu )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, std::initializer_list< size_t > vertexIndices, D3DVERTEXELEMENT9 element, const unify::V2< float > & v )
{
	size_t result = 0;
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, std::initializer_list< size_t > vertexIndices, D3DVERTEXELEMENT9 element, const unify::V3< float > & v )
{
	size_t result = 0;
	for( auto i : vertexIndices )
	{
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, std::initializer_list< size_t > vertexIndices, D3DVERTEXELEMENT9 element, const unify::V4< float > & v )
{
	size_t result = 0;
	for( auto i : vertexIndices )
	{
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, std::initializer_list< size_t > vertexIndices, D3DVERTEXELEMENT9 element, const unify::TexCoords & tc )
{
	size_t result = 0;
	for( auto i : vertexIndices )
	{
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, std::initializer_list< size_t > vertexIndices, D3DVERTEXELEMENT9 element, const unify::Color & c )
{
	size_t result = 0;
	for( auto i : vertexIndices )
	{
...
bool VertexDeclaration::WriteVertex( unify::DataLock & lock, std::initializer_list< size_t > vertexIndices, D3DVERTEXELEMENT9 element, const unify::ColorUnit & cu )
{
	size_t result = 0;
	for( auto i : vertexIndices )
	{
...
bool VertexDeclaration::ReadVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, unify::V2< float > & v )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
...
bool VertexDeclaration::ReadVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, unify::V3< float > & v )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
...
bool VertexDeclaration::ReadVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, unify::V4< float > & v )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
...
bool VertexDeclaration::ReadVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, unify::TexCoords & tc )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
...
bool VertexDeclaration::ReadVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, unify::Color & c )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
...
bool VertexDeclaration::ReadVertex( unify::DataLock & lock, size_t vertexIndex, D3DVERTEXELEMENT9 element, unify::ColorUnit & cu )
{
	D3DVERTEXELEMENT9 elementFound = {};
	if( !FindElement( element, elementFound ) )
	{
