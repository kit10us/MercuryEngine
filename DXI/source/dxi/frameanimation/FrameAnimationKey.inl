...
template< typename T >
void dxi::frameanimation::FindLeftRight( float time, const typename Key< T >::list & timeline, typename Key< T >::list::const_iterator & leftItr, typename Key< T >::list::const_iterator & rightItr )
{
...
template< typename T >
T dxi::frameanimation::InterpretValue( float time, const typename Key< T >::list & timeline, T defaultValue )
{
	if( timeline.empty() )
	{
		return defaultValue;
