#include <dxi/frameanimation/FrameAnimationKey.h>

template<>
unify::Quaternion dxi::frameanimation::InterpretValue< unify::Quaternion >( float time, const typename RotationKey::list & timeline, unify::Quaternion defaultValue )
{
	if( timeline.empty() )
	{
		return defaultValue;
