...
#pragma region Create vertex shader.
	...
	CreateVertexShader( dxDevice, "RotationCompute.hlsl", "vs_main", "vs_4_0", vertexShader3D, vertexShaderBuffer3D, vertexShaderReflection3D );
#pragma endregion
...
#pragma region Create pixel shader...
	...
	CreatePixelShader( dxDevice, "RotationCompute.hlsl", "ps_main", "ps_4_0", pixelShader3D, pixelShaderBuffer3D );
#pragma endregion

#pragma region Create compute shader.
	CComPtr< ID3D11ComputeShader > rotationComputeShader;
	CComPtr< ID3D10Blob > rotationComputeShaderBuffer;
	CComPtr< ID3D11ShaderReflection > rotationComputeShaderReflection;

	CreateComputeShader( dxDevice, "RotationCompute.hlsl", "RotationMain", "cs_5_0", rotationComputeShader, rotationComputeShaderBuffer, rotationComputeShaderReflection );
#pragma endregion
...
#pragma region The main loop...
	...
	while( forever )
	{
		...
		CComPtr< ID3D11ShaderReflection > rotationComputeShaderReflection;
		*/
		dxContext->CSSetShader( rotationComputeShader, 0, 0 );
