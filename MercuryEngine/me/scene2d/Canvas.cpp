...
void Canvas::OnUpdate( Scene * scene, const RenderInfo & renderInfo )
{
	...
	{
		e->Update( myRenderInfo );
	}
}

void Canvas::OnRender( Scene * scene, const RenderInfo & renderInfo )
{
	RenderInfo myRenderInfo( renderInfo );
