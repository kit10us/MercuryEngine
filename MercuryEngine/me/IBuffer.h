...
namespace me
{
	struct BufferParameters
	{
		...
		BufferParameters( size_t _sizeInBytes, me::BufferUsage::TYPE _usage = me::BufferUsage::Default, void * source = 0, unify::Flags _flags = 0 )
	...
	public:
		...
		virtual me::BufferUsage::TYPE GetUsage( size_t bufferIndex ) const = 0;
