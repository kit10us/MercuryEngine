...
void sg::CreateShape_Cube( IRenderer * renderer, PrimitiveList & primitiveList, unify::Parameters & parameters )
{
	...
	{
		std::vector< unify::TexArea > faceUV = parameters.Get< std::vector< unify::TexArea > >( "faceUV" );
